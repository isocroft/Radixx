	...
	_createClass(Dispatcher, [{
		...
		value: function register(title, observer, defaultStoreContainer) {
			...
			if (_basics.Hop.call(observers, title)) {
				...
				observer.$$history = [!!defaultStoreContainer ? defaultStoreContainer : null];
		...
		key: 'setActionsRegistry',
		value: function setActionsRegistry(regId) {

			dispatchRegistry[regId] = { actionTypes: [] };
		}
	}, {
		key: 'addToActonsRegistry',
		value: function addToActonsRegistry(id, vector) {
...
exports.isAppStateAutoRehydrated = exports.watchDispatcher = exports.setStoreObserver = exports.setActionVectors = exports.setMiddlewareCallback = exports.purgePersistStore = exports.mergeConfig = exports.setupShutdownCallback = exports.registerAction = exports.makeAggregator = exports.eachStore = undefined;
...
var getObjectPrototype = function getObjectPrototype(obj) {
	if ('getPrototypeOf' in Object) {
		...
		if (!_basics.Hop.call(obj, '__proto__')) {
			return obj.__proto__;
		}
	} else if ('constructor' in obj) {
		if (!_basics.Hop.call(obj, 'constructor')) {
	...
	return function () {
		...
		if (method == 'getState') {
			...
			var title = this.getTitle(),
			    value;
			area = new _dispatcher.Area(title);
			value = area.get();
			area = null;
...
var createActionInterface = function createActionInterface(dispatcher, vector) {
	...
	return function (data, stateAspectKey) {
		...
		if (vector.actionDefinition instanceof Array) {
			...
			(0, _basics.each)(vector.actionDefinition, function (definition) {
...
var setActionVectors = function setActionVectors(object, vectors) {
	...
	for (var creator in vectors) {
		if (_basics.Hop.call(vectors, creator)) {
...
exports.setMiddlewareCallback = setMiddlewareCallback;
exports.setActionVectors = setActionVectors;
...
var makeStore = function makeStore(dataTitle, registerCallback, defaultStateObj) {
    ...
    function _store() {
        ...
        _extras.Store.apply(this, [].concat(args));
    }
...
var makeActionCreators = function makeActionCreators(vectors) {
    function _action() {
        ...
        _extras.Action.apply(this, [].concat(args));
    }
...
var eachStore = function eachStore(callback) {
    ...
    return observable.eachStore(function () {
...
var onDispatch = function onDispatch(handler) {
    ...
    if (typeof handler === 'function') {
        ...
        observable.watchDispatcher(function () {
...
var onShutdown = function onShutdown(handler) {
    ...
    if (typeof handler === "function") {
        ...
        observable.setupShutdownCallback(function () {
            handler.apply(undefined, arguments);
        }, _hub);
    }
};
...
exports.Payload = _primitiveCheckers.Payload;
...
//# sourceMappingURL=radixx.umd.js.map